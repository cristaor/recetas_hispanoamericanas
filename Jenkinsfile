pipeline { 
    ...
    environment {
        ...
        GIT_REPO = 'MISW4101-202211-Grupo074'
        ...
        stage('Gitinspector') {
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: env.GITHUB_TOKEN_ID, passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
                    ...
                    sh('git pull https://${GIT_USERNAME}:${GIT_PASSWORD}@github.com/MISW-4101-Practicas/${GIT_REPO} desarrollo')
                    sh('git push https://${GIT_USERNAME}:${GIT_PASSWORD}@github.com/MISW-4101-Practicas/${GIT_REPO} desarrollo')
                }  
            }
        }
