...
class Vista_lista_carreras(QWidget):
    ...
    def mostrar_carreras(self, lista_carreras):
        ...
        if (self.carreras!= None and len(self.carreras)>0) :
            ...
            for dic_carrera in self.carreras:
                ...
                carrera_id=dic_carrera.id_carrera
                ...
                btn_ver_actividad.clicked.connect(partial(self.mostrar_carrera,carrera_id) )
                ...
                btn_editar.clicked.connect(partial(self.mostrar_apuestas,carrera_id ) )
                ...
                btn_terminar.clicked.connect(partial(self.terminar_carrera,carrera_id) )
                ...
                btn_eliminar.clicked.connect(partial(self.eliminar_carrera,carrera_id) )
                self.distribuidor_tabla_carreras.addWidget(btn_eliminar,numero_fila,4,Qt.AlignCenter)

                if dic_carrera.terminada:
    ...
    def terminar_carrera(self, id_carrera):
        ...
        if dialogo.resultado == 1:
            print("Competidor Ganador " + dialogo.ganador)
            self.interfaz.terminar_carrera(id_carrera, dialogo.ganador)
            self.hide()
            #self.interfaz.mostrar_reporte_ganancias(dialogo.combobox_competidores.currentData())
            self.interfaz.mostrar_reporte_ganancias()
